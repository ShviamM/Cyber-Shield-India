export default {
  ...
  hero: {
    badge: "Thag se 2 kadam aage",
    titleLine1: "India's",
    titleHighlight: "Digital Bodyguard",
    subtitle:
      "We stand between your family and financial fraud — blocking scam calls, detecting fake links and securing UPI in real-time.",
    ...
    activeProtection: "Active Protection ON",
    teaser: {
      title: "Check a Number or Link",
      placeholder: "e.g. 9876543210 or bit.ly/scam",
      analyzeCta: "Analyze Threat Level",
      scanning: "Running heuristic scan...",
      resultTitle: "This looks suspicious.",
      resultDesc: "Found in our threat database.",
      downloadToBlock: "Download to block",
    ...
    phone: {
      ...
      reported: "Reported: Courier Scam",
      block: "Block",
      ignore: "Ignore",
    },
  },
  ...
  radar: {
    ...
    bullets: [
      ...
      "Malicious UPI payment & QR code detection",
    ],
  },
  howItWorks: {
    heading: "Simple, Powerful Protection",
    subtitle:
      "Netraksh runs quietly in the background, analyzing threats in real-time without compromising your privacy.",
    steps: [
      {
        title: "Check Number",
        desc: "Instantly know if an incoming call is from a verified business or a reported scammer.",
      },
      {
        title: "Check Link",
        desc: "Our AI scanner analyzes URLs before you click, blocking phishing and fake sites.",
      },
      {
        title: "Check Message",
        desc: "Identify fake job offers, lottery scams, and urgent requests automatically.",
      },
      {
        title: "Report Fraud",
        desc: "Contribute to the national safety network by easily reporting suspicious activity.",
      },
    ],
  },
  tryChecker: {
