...
const en = {
  ...
  callAlert: {
    ...
    statusVerified: "Verified scam",
    statusReported: "Reported",
    statusClean: "No reports",
    safeHeadline: "No scam reports for this number",
    cautionHeadline: "Reported by the community — stay cautious",
    unknownHeadline: "Couldn't verify this number — stay cautious",
  ...
  screening: {
    ...
    reliability: {
      batteryTitle: "Keep running in background",
      batterySub: "Allow unrestricted battery use so the caller popup isn't killed.",
      batteryDone: "Battery use is unrestricted.",
      autostartTitle: "Allow autostart",
      autostartSub: "On {{brand}} devices, enable autostart so alerts work when the app is closed.",
      fix: "Fix",
      open: "Open",
    },
    testAlert: {
      cta: "Send a test alert",
      hint: "Lock your phone, then check the caller card appears.",
      sentTitle: "Test alert sent",
      sentMsg: "Lock your screen now — the caller card should appear like a real call. If it doesn't, finish the setup and reliability steps above.",
      failTitle: "Couldn't send test alert",
      failMsg: "The test alert needs the installed Android app. It can't run in this preview or Expo Go.",
    },
    popupWarn: {
